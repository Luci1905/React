...
function CadastroUsuario() {
    ...
    const [nome, setNome] = useState<string>("");//""significa texto vazio
    const [email, setEmail] = useState<string>("");
    const [senha, setSenha] = useState<string>("");
    const [cep, setCep] = useState<string>("");
    const [foto, setFoto] = useState<any>();//valor inicial indefinido
    ...
    function cadastrarUsuario(event: any) {
        ...
        //utilizado formData quando tiver arquivo(video, pdf, foto etc..)
        const formData = new FormData();
        //A chave da funcao do append()precisa ser o mesmo nome do atributo que api retorna.
        ...
        .catch((error: any) =>{
            console.log(error);
            alert("Falha ao cadastrar um novo ususario"); 
        })
    }
